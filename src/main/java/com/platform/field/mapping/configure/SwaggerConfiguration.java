...
public class SwaggerConfiguration {
	...
	public Docket createRestApi() {
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select().apis(RequestHandlerSelectors.basePackage("com.platform.field.mapping.provider")).paths(PathSelectors.any()).build();
	}

...
public interface FieldMappingMapper {
	...
	List<FieldMapping> selectFieldByList(@Param("fieldName") String fieldName, @Param("paramList") List<String> paramList, @Param("splitSize") int splitSize, @Param("example") FieldMappingExample example);
}